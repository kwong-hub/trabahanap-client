...
import { faPlus,faCheckCircle, faCheck, faSlidersH, faTimesCircle,faEllipsisV, faArrowCircleRight, faTimes } from '@fortawesome/free-solid-svg-icons';
...
export class ApplicationsListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['firstName', 'email','phoneNumber','jobtitle','Employeer','applicationDate','hired'];
