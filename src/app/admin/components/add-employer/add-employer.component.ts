...
import { faCheck, faUserPlus, faIdCard, faCloudUploadAlt, faUserCheck, faEyeDropper, faEdit, faTimes } from '@fortawesome/free-solid-svg-icons';
...
export class AddEmployerComponent implements OnInit {
  ...
  constructor(private router: Router, private formBuilder: FormBuilder, 
    ...
    private adminService: AdminService, private _location: Location,) { }
  ...
  onSubmit(){
    this.submitted = true;
    if(this.addEmployer.invalid){return;}
    ...
    this.adminService.addEmployer(this.formData)
      .subscribe(
        success => {
          //console.log(success)
          if(success.success){
