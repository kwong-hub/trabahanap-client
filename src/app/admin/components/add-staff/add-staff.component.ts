...
export class AddStaffComponent implements OnInit {
  ...
  previousStaffs = [];
  companyId;
  constructor(private formBuilder: FormBuilder, private adminServices: AdminService,private Route: ActivatedRoute) { }
  ...
  onSubmit(){
    ...
    this.adminServices.addStaff(values,this.companyId)
      .subscribe(
        success => {
          console.log(success)
          if(success.success){
