...
export class ApplicantService {
  ...
  getJobApplications(page): Observable<any> {
    return this.http.get<any>(`${environment.apiUrl}/applicant/jobs?page=${page}`)
  }
  ...
  getSavedJobs(page): Observable<any> {
    return this.http.get<any>(`${environment.apiUrl}/applicant/jobs/saved?page=${page}`)
  }
  ...
  getFilterSavedJobs(jobtitle,industry,company,page):Observable<any>{
    return this.http.get<any>(`${environment.apiUrl}/applicant/filter/jobs/saved?job=${jobtitle}&industry=${industry}&company=${company}&page=${page}`);
  }
  getFilterAppliedJobs(jobtitle,industry,company,page):Observable<any>{
    return this.http.get<any>(`${environment.apiUrl}/applicant/filter/jobs/applications?job=${jobtitle}&industry=${industry}&company=${company}&page=${page}`);
  }
