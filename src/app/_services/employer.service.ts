...
export class EmployerService {
  ...
  getFilterJobsApplications(jobtitle, industry, position, page, pageSize) {
    return this.http.get<any>(
      `${environment.apiUrl}/employer/filter/jobs/applications?job=${jobtitle}&industry=${industry}&position=${position}&page=${page}&pageSize=${pageSize}`
    );
  }

  getFilterJobsFilteredApplications(jobtitle, industry, position, page, pageSize) {
    return this.http.get<any>(
      `${environment.apiUrl}/employer/filter/filtered/applications?job=${jobtitle}&industry=${industry}&position=${position}&page=${page}&pageSize=${pageSize}`
    );
  }
