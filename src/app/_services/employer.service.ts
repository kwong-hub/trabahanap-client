...
export class EmployerService {
  ...
  editCompanyProfile(companyProfile, id): Observable<any> {
    return this.http.put<any>(
      `${environment.apiUrl}/employer/profile/${id}`,
      companyProfile
    );
  }
  ...
  deleteEmployerJob(id): Observable<any> {
    return this.http.put(
      `${environment.apiUrl}/employer/jobs/delete/${id}`,
      {}
    );
  }
  ...
  getCompanyLocationById(id): Observable<any> {
    return this.http.get<any>(
      `${environment.apiUrl}/employer/profile/locations/${id}`
    );
  }
  ...
  editCompanyBranchPicture(companyImage, id): Observable<any> {
    return this.http.put<any>(
      `${environment.apiUrl}/employer/profile/locations/picture/${id}`,
      companyImage
    );
  }
  ...
  changeCompanyLogo(formData: FormData): Observable<any> {
    return this.http.post<any>(
      `${environment.apiUrl}/employer/profile/logo`,
      formData
    );
  }
  ...
  chnageBusinessLicense(formData: FormData): Observable<any> {
    return this.http.post<any>(
      `${environment.apiUrl}/employer/profile/businessLicense`,
      formData
    );
  }
  ...
  getApplicant(id) {
    return this.http.get<any>(
      `${environment.apiUrl}/employer/jobs/applications/applicant/${id}`
    );
  }

  getIsHired(id, jobId) {
    return this.http.get<any>(
      `${environment.apiUrl}/employer/jobs/applications/applicant/hired/${id}/${jobId}`
    );
  }
  sendIssue(formData): Observable<any> {
    return this.http.post<any>(
      `${environment.apiUrl}/employer/issues`,
      formData
    );
  }
