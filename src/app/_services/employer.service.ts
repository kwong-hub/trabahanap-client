...
export class EmployerService {
  ...
  getFilterJobsApplications(jobtitle,industry,position,page){
    return this.http.get<any>(`${environment.apiUrl}/employer/filter/jobs/applications?job=${jobtitle}&industry=${industry}&position=${position}&page=${page}`);
  }
  
  getFilterJobsFilteredApplications(jobtitle,industry,position,page){
    return this.http.get<any>(`${environment.apiUrl}/employer/filter/filtered/applications?job=${jobtitle}&industry=${industry}&position=${position}&page=${page}`);
  }
  ...
  getFilterApplications(applicantName,job,page){
    return this.http.get<any>(`${environment.apiUrl}/employer/filter/applications?applicant=${applicantName}&job=${job}&page=${page}`)
  }
  getJobsFilter(jobtitle,industry,position,page){
    return this.http.get<any>(`${environment.apiUrl}/employer/filter/jobs?job=${jobtitle}&industry=${industry}&position=${position}&page=${page}`);
