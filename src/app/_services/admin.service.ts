...
export class AdminService {
  ...
  confirmPayment(id): Observable<any> {
    return this.http.put<any>(`${environment.apiUrl}/admin/confirm/payment/${id}`, {});
  }
  ...
  getFilterApplications(applicantName, jobtitle, companyName, page, pageSize) {
    return this.http.get<any>(
      `${environment.apiUrl}/admin/filter/applications?applicant=${applicantName}&job=${jobtitle}&company=${companyName}&hired=&page=${page}&pageSize=${pageSize}`
    );
  }
