...
export class ReportJobComponent implements OnInit {
  ...
  options = [
    ...
    { name: "Offensive content", value: "Offensive content" }, { name: "Up-front payment required", value: "Up-front payment required" },
    { name: "Scam/Fraud", value: "Scam/Fraud" }, { name: "Others", value: "Others" }
  ];
  jobId: any;
  invalidFields: any[];
  jobAdded: boolean;
  ...
  onSubmit() {
    ...
    this.loading = true;
    this.applicantService.reportJob({ ...val },this.jobId)
      .subscribe(
        success => {
