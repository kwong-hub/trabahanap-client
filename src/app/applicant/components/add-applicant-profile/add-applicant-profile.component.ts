...
export class AddApplicantProfileComponent implements OnInit {
  ...
  countries: any;
  cities: any;
  genderOptions: any = [{name: 'MALE', value: 'MALE'}, {name: 'FEMALE', value: 'FEMALE'}];
  monthOptions = [{name: 'January' , value: '01'}, {name: 'February' , value: '02'},
    {name: 'March' , value: '03'}, {name: 'April' , value: '04'}, {name: 'May' , value: '05'}, 
    {name: 'June' , value: '06'}, {name: 'July' , value: '07'}, {name: 'August' , value: '08'}, 
    {name: 'September' , value: '09'}, {name: 'October' , value: '10'},
    {name: 'November' , value: '11'}, {name: 'December' , value: '12'}]
  hasProfile:boolean = false;
  submitted:boolean = false;
  styleObject = {'inputContainer': {},'input':{fontSize:'1.7rem'},'inputHeader': {fontSize: "1.7rem", borderBottom: "1px solid #888"}, 'optionContainer': {backgroundColor: "#555", top: "3.3rem", boxShadow: '0px 1px 2px #aaa'}, 'option': {fontSize: "1.5rem", borderBottom: "1px solid #ddd", backgroundColor: '#fff'}};
  monthStyle = {'inputContainer': {margin: "0"}, 'inputHeader': {fontSize: "1.5rem", borderBottom: "1px solid #888"}, 'optionContainer': {backgroundColor: "#555", top: "3.3rem", boxShadow: '0px 1px 2px #aaa'}, 'option': {fontSize: "1.5rem", borderBottom: "1px solid #ddd", backgroundColor: '#fff'}};
  dateStyle = {'inputContainer': {marginRight: "0"}, 'input': {}, 'label': {}, 'feedbackContainer': {}, 'feedbackMessage': {}};
  ...
  onSubmit(){
    ...
    // console.log(this.addApplicantProfileForm.value);
    if(this.addApplicantProfileForm.invalid){ return; }
    ...
    this.applicantService.addApplicantProfileWithCV(this.formData)
      .subscribe(
        data => {
          console.log(data)
          if(data.success){
            ...
            this.authService.updateCurrentUser({...currentUser, hasFinishedProfile:true, applicantProfile: data.applicantProfile});
  ...
  applicantUpdated(event){
    ...
    this.applicantProfile.dateOfBirth = this.applicantProfile.dateOfBirth ? this.applicantProfile.dateOfBirth.split('T')[0] : null;
    let currentUser = this.authService.currentUserValue;
    this.authService.updateCurrentUser({...currentUser, hasFinishedProfile:true, applicantProfile: event});        
    this.updateForm();
    // console.log(event);
  }
}
