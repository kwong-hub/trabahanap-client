...
const routes: Routes = [
  ...
  children: [
    ...
    { path: 'applications', canActivate: [ApplicantGuard], component: ApplicationsComponent, resolve: {jobs: ApplicantApplicationsResolverService} },
    { path: 'applications/details/:id', canActivate: [ApplicantGuard], component: JobDetailComponent, resolve: {data: JobDetailResolverService} },
    { path: 'bookmarks', canActivate: [ApplicantGuard], component: CompaniesComponent, resolve: {jobs: ApplicantSavedApplicationsResolverService}},
    { path: 'bookmarks/details/:id', canActivate: [ApplicantGuard], component: JobDetailComponent, resolve: {data: JobDetailResolverService} },
    { path: 'profile', canActivate: [ApplicantGuard], component: ProfileComponent, resolve: {data: ApplicantProfileResolverService}  },
    { path: 'issues', canActivate: [ApplicantGuard], component: ReportIssueComponent },
    { path: 'issues/details/:id', canActivate: [ApplicantGuard], component: IssueDetailsComponent, resolve: {data: IssueDetailResolverService} },
    { path: 'password', canActivate: [ApplicantGuard], component: ChangePasswordComponent },
    { path: 'jobs/details/:id', canActivate: [ApplicantGuard], component: JobDetailComponent, resolve: {data: JobDetailResolverService}},
    { path: 'jobs/report/:id',canActivate:[ApplicantGuard],component:ReportJobComponent}
  ]}
];
